					...
					if (paypal === true) {
						...
						orderSummaryHTML = `
						 <div style="border: 1px solid #ccc; padding: 20px; max-width: 400px; margin: 0 auto; text-align: center;">
							...
							<a href="#" style="display: inline-block; background-color: #ffc439; color: #000; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-weight: bold; height: 50px; line-height: 30px;">
