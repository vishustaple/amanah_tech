...
$(document).ready(function () {
  ...
  function saveCanvas(event) {
    ...
    const clickedButton = event.target,
      ...
      element = document.getElementById("policy_contant_" + dataId + ""),
          ...
          success: function (response) {
            ...
            if (response.success) {
              ...
              if (dataId == 1) {
                ...
                $("#policy_contant_" + dataId + "").hide();
                $("#policy_contant_" + newWrapId + "").show();
                clearCanvas();
                ...
                let storedFiles =
                  JSON.parse(localStorage.getItem("filePaths")) || []; // Retrieve existing
