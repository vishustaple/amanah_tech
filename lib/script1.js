...
// Get the updated quantity and append it to the order summary
    ...
    if (!cardNumberValid || !cvvValid || !monthValid || !yearValid || !nameValid || !emailValid || !phoneValid || !addressValid) {
	...
	function validateCardNumber(input) {
		...
		if (!cardNumberRegex.test(value)) {
			...
			cardImageContainer.style.display = 'block'; // Show card image container (if needed)
