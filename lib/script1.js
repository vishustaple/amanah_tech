						...
						if (data.error=="none") {
							$.ajax({
								...
								success : function(checkoutResponse) {
									...
									$('#statedropdown').val(checkoutResponse.state); // If 'state' is a predefined list of options, make sure the correct option has the same value as the state
		...
		$('.submitButton').on('click', function(e) {
			...
			$.ajax({
				...
				success: function(response) {
					...
					// You can also do things like show a success message or redirect the user
				},
