$(document).ready(function(){
	...
	$(document).ready(function() {
		...
		// Find the parent form of the clicked button (assumes #login-button is inside the form)
		const form1 = $('#loginf');

		// Find all input elements within the form
		const inputs1 = form1.find('input');
		...
		$('#login-button').click(function (event) {
			...
			// Find the parent form of the clicked button (assumes #login-button is inside the form)
			const form = $(this).closest('form'); // .closest('form') ensures you're selecting the form containing the button
		...
		$('#forgotpassword').click(function (event) {
			...
			// Find the parent form of the clicked button (assumes #login-button is inside the form)
			const form = $(this).closest('form'); // .closest('form') ensures you're selecting the form containing the button
			const emailInput = form.find('input'); // Get the email input
			
			const email = emailInput.val();
			const invalidFeedback = emailInput.siblings('.invalid-feedback');
		...
		// $('.send-forgot-button').click(function(event){
