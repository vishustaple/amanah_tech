...
// Get the updated quantity and append it to the order summary
			updatePrices();
			SomeNewFunctionality(globalQuantity);
        });
		...
		function SomeNewFunctionality(value){
			...
			const setupPrice = cleanSetUpCost * value;
			const orderTotal = cleanTotalPriceText * value;
			const  newOrderCountData = `
				<div class="items_list">
					...
					<div class="items_config">
						...
						<h5 class="items_config_title" data-OrderCount="">${value} <i class="fa fa-caret-down" aria-hidden="true"></i></h5>
					</div>
				</div>
					<div class="items_list">
					<div class="items_name">
					...
					<div class="items_config">
						<h5 class="items_config_title "></h5>
						<h5 class="items_config_title" data-OrderCount="">${formatCurrencyCustom(orderTotal)} <i class="fa fa-caret-down" aria-hidden="true"></i></h5>
					</div>
				</div>
					<div class="items_list">
					<div class="items_name">
					...
					<div class="items_config">
						<h5 class="items_config_title "></h5>
						<h5 class="items_config_title" data-OrderCount="">${formatCurrencyCustom(setupPrice)} <i class="fa fa-caret-down" aria-hidden="true"></i></h5>
					</div>
				</div>
			`;
