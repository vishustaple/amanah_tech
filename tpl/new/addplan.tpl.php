            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center p-0 mt-3 mb-2">
               <div class="card px-3 pt-4 pb-0 mt-3 mb-3" >
                  <div id="orderForm">
                     ...
                     <input type="text" placeholder="Last Name" name="lname" value="ipsum" required="">
                     </span>
                     </div>
                     </div>
                     <div class="col-md-6">
                     ...
                     <input type="text" placeholder="Phone Number" name="phone" value="8585200214" required="">
                     </span>
                     </div>
                     </div>
                     <div class="col-md-6">
                     ...
                     <span>
                     <label>Address*</label>
                     <input type="text" placeholder="Address" name="address" value="Sorjani nagar" required=""> 
                     </span>
                     </div>
                     </div>
                     <div class="col-md-6">
                     ...
                     <span>
                     <label>City*</label> 
                     <input type="text" placeholder="City" name="city" id="city" value="" required="">
                     </span>
                     </div>
                     </div>
                     <div class="col-md-6">
                     ...
                     <input type="text" class="disp-inline" placeholder="State" name="state" id="state" value="">
                     ...
                     <input type="text" placeholder="Zip Code / Postcode" value="110023" name="zip" required="">
                     </span>
                     </div>
                     </div>
                     <div class="col-md-6">
                     ...
                     <span>
                     <label>Country*</label> 
                     <select class="country-select tax-form-data" name="country" id="country" required="">
                     <option value="" disabled="" selected="selected">Select a Country</option>
                     <option value="CA">Canada</option>
                     <option value="US">United States</option>
                     <option value="seperator" disabled="">--------</option>
