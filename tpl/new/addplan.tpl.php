														...
														<div class="form-group">
															<span>
																...
																<input type="text" placeholder="Phone Number"
																	name="phone" value="8585200214" required="">
															</span>
														</div>
													</div>
													<div class="col-md-6">
														...
														<div class="form-group">
															<span>
																...
																<input type="text" placeholder="Zip Code / Postcode"
																	value="110023" name="zip" required="">
															</span>
														</div>
													</div>
													<div class="col-md-6">
													...
													<div class="col-md-6">
														<div class="form-group">
															<span>
																...
																<input type="text" name="company" value="set dmet"
